...
Nova.booting(function (Vue, router, store) {
    Vue.component('form-nova-template-field', __webpack_require__(2));
});
        ...
        handleChange: function handleChange(value) {
            ...
            if (value) {
                ...
                this.$nextTick(function () {
                    return _this.component.$forceUpdate();
                });
                console.log(this.component);
            }
        },
        findComponent: function findComponent(root) {
            var _this2 = this;
            ...
            root.$children.forEach(function (component) {
                if (component.field && component.field.attribute === _this2.field.fillField) {
                    _this2.component = component;
                }
                _this2.findComponent(component);
            });
        }
    },
